//
//  GroundViewViewController.swift
//  AI Parking Detector
//
//  Created by Kevaughn Clarke on 10/11/20.
//
...
class GroundViewViewController: UIViewController, UINavigationControllerDelegate {
    ...
    lazy var detectionRequest: VNCoreMLRequest = {
        do{
            let model = try VNCoreMLModel(for: GroundView().model)   //model
...
//MARK:- process, draw, and update detections
    ...
    @IBAction func imgPickerBtnPressed(_ sender: UIBarButtonItem) {
        present(imagePicker, animated: true, completion: nil)
    }
...
extension GroundViewViewController: UIImagePickerControllerDelegate{
